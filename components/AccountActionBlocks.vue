    ...
    <div class="account-action-blocks mb-6 has-radius is-horizontal-centered">
      <div class="columns">
        <div class="is-half column">
          <!-- Refer block -->
          <div class="account-action-block px-6 pt-5 has-radius">
            <h3 class="mb-3 px-2 has-text-weight-medium">Refer friends for extra tickets</h3>
        ...
        <!-- Task block -->
        <div class="is-half column">
          <div class="account-action-block px-6 has-radius">
            <h3 class="mb-3 px-2 has-text-weight-medium">Do a task for extra tickets</h3>
          </div>
        </div>
      </div>
    </div>
