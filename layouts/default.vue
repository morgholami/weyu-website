<template>
  <div id="app" :class="{ 'homepage': $route.path == '/', 'light': $route.path == '/login' || $route.path == '/whitepaper' || $route.path == '/invest' }">
    <nav-bar/>
    <div id="content">
      <Nuxt/>
    </div>
  ...
  //  }
    &.homepage:before {
      ...
      background:
              ...
              radial-gradient(circle at bottom right, rgba($primary, 0.5) 0%, rgba($primary, 0) 30%),
              radial-gradient(circle at top right, rgba($secondary, 0.3) 0%, rgba($secondary, 0) 15%);
